...
Use pre-defined test cases together with your pre-defined network topology and apply this to your actual network and have the tests confirm what the tests expect.
...
#. **Test bundles** in the form of YAML-files that specify the actual tests. A test bundle is a series of tests that are logically related to each other. Each test bundle is structured in a similar way, but has specific fields tailored to the test bundle. Field values in a test bundle are directly related to your inventory.
...
Enhance NUTS
------------
Since NUTS is written as a pytest plugin and in python, you can customize it yourself and write your own test bundles. Please see the :doc:`development section <dev/index>` to see how NUTS is structured and how you can write your own test bundles. The :doc:`API section <api/index>` contains the auto-generated docstrings of the project.
