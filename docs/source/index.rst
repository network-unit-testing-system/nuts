...
We do not support self-written tests at the moment, since planned refactorings might introduce breaking changes. Still, you can already write your own test classes! The ``nuts/base_tests`` folder in the code repository conatins sample implementations and :doc:`the development section <dev/writetestclasses>` has a short introduction.
...
.. toctree::
   ...
   Development <dev/writetestclasses>
