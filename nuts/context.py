...
from nuts.helpers.errors import NutsSetupError, NutsUsageError
...
class NornirNutsContext(NutsContext):
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            raise NutsUsageError('Nornir configuration file not found! Please provide a correct nornir configuration '
                                 'at "nr-config.yaml" (default) or by passing the "--nornir-config" parameter to the '
                                 'test invocation.') from exc
