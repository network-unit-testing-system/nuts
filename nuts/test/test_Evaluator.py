...
class TestEvaluator:
    ...
    def test_comp_multiple_devices(self, test_suite, evaluator):
    ...
    def test_comp_multiple_devices_false(self, test_suite, evaluator):
        test_case = test_suite.get_test_by_name('checkuser multiple devices')
        result = {
            u'cisco.csr.1000v': {"resulttype": "single", "result": ['admin', 'user']},
    ...
    def test_comp_multiple(self, evaluator):
        list1 = []
        list2 = []
        list1.append('admin')
        list1.append('user')
    ...
    def test_comp_multiple_false(self, evaluator):
        list1 = []
        list2 = []
        list1.append('admin')
        list1.append('user')
    ...
    def test_compare_single_true(self, test_suite, evaluator):
    ...
    def test_compare_single_false(self, test_suite, evaluator):
    ...
    def test_compare_multiple_true(self, test_suite, evaluator):
    ...
    def test_compare_multiple_false(self, test_suite, evaluator):
